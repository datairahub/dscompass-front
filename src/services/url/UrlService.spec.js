...
describe('UrlService.js', () => {
  ...
  it('getQueryStringParam() returns query params', () => {
    ...
    expect(urlService.getQueryStringParam('lorem', url)).toBe('ipsum');
    expect(urlService.getQueryStringParam('dolor', url)).toBe('sit');
  });

  fit('getQueryStringParam() returns array query params', () => {
